                ...
                <div className="sidebar">
                    ...
                    <nav className="mt-2">
                        <ul className="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            {can['product-list'] && (
                                <>
                                    <li className={`nav-item ${(route().current('product.index') || route().current('product.create')) && 'menu-is-opening menu-open'}`}>
                                        <a href="#" className={`nav-link ${(route().current('product.index') || route().current('product.create')) && 'active'}`}>
                                        ...
                                        <ul className="nav nav-treeview">
                                            <li className="nav-item">
                                                <Link href={route('product.index')} className={`nav-link ${route().current('product.index') && 'active'}`}>
                                                    <i className="fa-solid fa-list-ul nav-icon text-warning"></i>
                                                    <p>LIST</p>
                                                </Link>
                                            </li>
                                            <li className="nav-item">
                                                <Link href={route('product.create')} className={`nav-link ${route().current('product.create') && 'active'}`}>
                            ...
                            {can['verify-list'] && (
                                <li className="nav-header">VERIFY</li>
                            )}
                            {can['verify-list'] && (
                                <>
                                    <li className={`nav-item ${(route().current('telegram.verify.form')) && 'menu-is-opening menu-open'}`}>
                                        <a href="#" className={`nav-link ${(route().current('telegram.verify.form')) && 'active'}`}>
                                            <i className="nav-icon far fa-plus-square"></i>
                                            <p> TELEGRAM
                                                <i className="fas fa-angle-left right"></i>
                                            </p>
                                        ...
                                        <ul className="nav nav-treeview">
                                            <li className="nav-item">
                                                <Link href={route('telegram.verify.form')} className={`nav-link ${route().current('telegram.verify.form') && 'active'}`}>
                                                    <i className="fa-solid fa-list-ul nav-icon text-warning"></i>
                                                    <p>VERIFY KEY</p>
                                                </Link>
                                            </li>
