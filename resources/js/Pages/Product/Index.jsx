...
export default function CategoriesPage({ productData }) {
    ...
    const confirmDataDeletion = (data) => {
        ...
        setDeleteData('photo', data.photo)
    ...
    const deleteDataRow = (e) => {
        e.preventDefault();
        destroy(route('product.destroy', dataEdit.id), {
            preserveScroll: true,
                                            ...
                                            datasList.map((item, k) => (
                                                <tr key={k}>
                                                    ...
                                                    <td>
                                                        ...
                                                        alt={item.title}
                                                        className="w-full max-w-[80px] h-10 object-cover rounded mb-2 mx-auto"
                                                        />
                                                    </td>
                                                    <td>{item?.title}</td>
                                                    <td>{item?.price}</td>
                                                    ...
                                                    <td width={'170px'}>
                                                        <Link href={route('product.edit', item.id)} className="btn btn-info btn-xs mr-2">
